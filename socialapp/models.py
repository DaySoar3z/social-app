...
class Postagem(models.Model):
    ...
    autor_postagem = models.ForeignKey(User, on_delete=models.CASCADE)
...
class Comentario(models.Model):
    ...
    def __str__(self):
        return f'{self.autor.username} comentou em {self.post.titulo_postagem}'
...
class Curtida(models.Model):
    ...
    class Meta:
        unique_together = ('post', 'usuario')  # Um usuário só pode curtir uma vez

    def __str__(self):
        return f'{self.usuario.username} curtiu {self.post.titulo_postagem}'